...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      <div className="task">
        <h3>Наибольшее из трёх чисел</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Строка в верхний регистр</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Удаление всех пробелов из строки</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Количество символов без .length</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Содержит ли строка подстроку</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Сумма чётных чисел массива</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Количество элементов больше заданного числа</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Удаление первого элемента массива</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Добавление элемента в начало массива</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Максимальное значение массива</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Минимальное значение массива</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Разворот массива вручную (без reverse)</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Сумма элементов на чётных индексах</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Есть ли элемент в массиве</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Объект пользователя с полями name и age</h3>
        <div className="result">
      ...
      <div className="task">
        <h3>Добавление нового свойства объекту</h3>
      ...
      <div className="task">
        <h3>Изменить цвет текста элемента при клике</h3>
      ...
      <div className="task">
        <h3>Скрывать элемент при нажатии кнопки</h3>
        {visible && (
          <div
            style={{
              background: '#1e1b4b',
      ...
      <div className="task">
        <h3>Показать значение input при нажатии кнопки</h3>
        <input
          type="text"
      ...
      <div className="task">
        <h3>Добавить элемент в список при клике</h3>
        <input
          type="text"
      ...
      <div className="task">
        <h3>Очистить поле ввода после отправки</h3>
        <form
          onSubmit={e => {
            e.preventDefault()
            if (!listInput.trim()) return
